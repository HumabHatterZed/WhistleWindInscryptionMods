...
namespace WhistleWindLobotomyMod {
    public class Boons {
        ...
        internal static void Initialise() {
            Texture2D background = TextureLoader.LoadTextureFromFile("boonRoseBackground.png", LobotomyPlugin.ModAssembly);
            RoseCurse = BoonManager.New<StainingRoseBoon>(LobotomyPlugin.pluginGuid,
                "Curse of the Rose", "At the end of your turn, all cards on your side of the board gain 1 Paper Rose.",
                TextureLoader.LoadTextureFromFile("boonRoseIcon1.png", LobotomyPlugin.ModAssembly), background,
                false, true);
