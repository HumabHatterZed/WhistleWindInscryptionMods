...
namespace WhistleWindLobotomyMod {
    public class TalkingCardChesed : CustomPaperTalkingCard {
        ...
        public override FaceInfo FaceInfo => new(voiceId: "female1_voice", blinkRate: 4f, voiceSoundPitch: 1f);
        ...
        public override List<EmotionData> Emotions {
            get {
                Sprite face = LoadSpriteFromFile("talkingChesedBody.png", new Vector2(0.5f, 0f));
        ...
        public override Dictionary<Opponent.Type, string> OnDrawnSpecialOpponentDialogueIds => new()
        {
            ...
            { LobOpponentUtils.ApocalypseBossID, "ChesedApocalypse" },
            { OrdealUtils.OpponentID, "ChesedOrdeal" },
            { OrdealUtils.SweeperOpponentID, "ChesedSweeper" }
        };
