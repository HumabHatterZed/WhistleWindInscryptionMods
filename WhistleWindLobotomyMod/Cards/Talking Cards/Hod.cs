...
namespace WhistleWindLobotomyMod {
    public class TalkingCardHod : CustomPaperTalkingCard {
        ...
        public override FaceInfo FaceInfo => new(voiceId: "female1_voice", blinkRate: 4f, voiceSoundPitch: 1.4f);
        ...
        public override Dictionary<Opponent.Type, string> OnDrawnSpecialOpponentDialogueIds => new()
        {
            ...
            { LobOpponentUtils.ApocalypseBossID, "HodApocalypse" },
            { OrdealUtils.OpponentID, "HodOrdeal" },
            { OrdealUtils.SweeperOpponentID, "HodSweeper" }
        };
