...
namespace WhistleWindLobotomyMod {
    public class TalkingCardBinah : CustomPaperTalkingCard {
        ...
        public override FaceInfo FaceInfo => new(voiceId: "female1_voice", blinkRate: 5f, voiceSoundPitch: 0.9f);
        ...
        public override List<EmotionData> Emotions {
            get {
                Sprite face = LoadSpriteFromFile("talkingBinahBody.png", new Vector2(0.5f, 0f));
        ...
        public override Dictionary<Opponent.Type, string> OnDrawnSpecialOpponentDialogueIds => new()
        {
            ...
            { LobOpponentUtils.ApocalypseBossID, "BinahApocalypse" },
            { OrdealUtils.OpponentID, "BinahOrdeal" },
            { OrdealUtils.SweeperOpponentID, "BinahSweeper" }
        };
