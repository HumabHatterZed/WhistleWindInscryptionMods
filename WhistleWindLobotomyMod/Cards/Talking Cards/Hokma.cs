...
namespace WhistleWindLobotomyMod {
    public class TalkingCardHokma : CustomPaperTalkingCard {
        ...
        public override FaceInfo FaceInfo => new(voiceId: "female1_voice", blinkRate: 5f, voiceSoundPitch: 0.8f);
        ...
        public override Dictionary<Opponent.Type, string> OnDrawnSpecialOpponentDialogueIds => new()
        {
            ...
            { LobOpponentUtils.ApocalypseBossID, "HokmaApocalypse" },
            { OrdealUtils.OpponentID, "HokmaOrdeal" },
            { OrdealUtils.SweeperOpponentID, "HokmaSweeper" }
        };
