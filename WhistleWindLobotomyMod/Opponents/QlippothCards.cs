    ...
    public static class QlippothCards {
        ...
        internal static void InitialiseQlippothCardInfos() {
            Dictionary<string, CardModificationInfo> retval = new() {
                ...
                { Cards.dontTouchMe, new() { fromCardMerge = true, abilities = new() { Ability.WhackAMole } } },
                ...
                { Cards.theresia, new(0, 1) { fromCardMerge = true, abilities = new() { Healer.ability } } },
                ...
                { Cards.wisdomScarecrow, new(0, 3) { fromCardMerge = true, abilities = new() { MindStrike.ability } } },
                { Cards.yang, new() { fromCardMerge = true, abilities = new() { Ability.MoveBeside } } },
