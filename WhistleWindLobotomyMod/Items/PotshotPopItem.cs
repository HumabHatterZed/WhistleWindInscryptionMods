...
{
    public class PotshotPopItem : NoFirstPersonTargetSlotItem
    {
        ...
        public override IEnumerator OnValidTargetSelected(CardSlot target, GameObject firstPersonItem)
        {
            ...
            yield return SodaAbilityBehaviour.Sequence(targetCard, PotshotPopEffect.specialAbility, Ability.Sentry, 2, PotshotPop.id);
