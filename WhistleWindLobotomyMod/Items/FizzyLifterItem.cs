...
{
    public class FizzyLifterItem : NoFirstPersonTargetSlotItem
    {
        ...
        public override IEnumerator OnValidTargetSelected(CardSlot target, GameObject firstPersonItem)
        {
            ...
            yield return SodaAbilityBehaviour.Sequence(targetCard, FizzyLifterEffect.specialAbility, Ability.Flying, 3, FizzyLifter.id);
