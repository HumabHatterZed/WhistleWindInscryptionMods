...
{
    public class SurefireDrinkItem : NoFirstPersonTargetSlotItem
    {
        ...
        public override IEnumerator OnValidTargetSelected(CardSlot target, GameObject firstPersonItem)
        {
            ...
            yield return SodaAbilityBehaviour.Sequence(targetCard, SurefireDrinkEffect.specialAbility, Ability.Sniper, 1, SurefireDrink.id);
