...
namespace WhistleWind.AbnormalSigils
{
    public partial class AbnormalPlugin
    {
        private void Ability_HighStrung()
        {
            ...
            const string rulebookDescription = "At the end of the current turn, this card gains Haste equal to twice the opposing card's Power.";
    ...
    public class HighStrung : AbilityBehaviour
    {
        ...
        private IEnumerator AddHasteToCard(int stacks)
        {
            ...
            Haste component = base.Card.GetStatusEffect<Haste>();
            if (component != null)
                component.UpdateStatusEffectCount(stacks, false);
            else
                base.Card.AddStatusEffectToCard<Haste>(stacks);
